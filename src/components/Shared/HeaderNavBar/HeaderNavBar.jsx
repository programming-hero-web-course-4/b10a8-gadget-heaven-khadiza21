...
const HeaderNavBar = () => {
  ...
  const activeStyle = {
    fontWeight: "bold",
    color: isHome ? "#FFFFFF" : "#9538E2",
    borderBottom: isHome ? "2px solid #FFFFFF" : "2px solid #9538E2",
  };
      ...
      <Container>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="mx-auto">
            {["/home", "/dashboard", "/statistics", "/about"].map((path, index) => (
              <NavLink
                key={index}
                to={path}
          ...
          <Nav>
            <span className="d-flex fw-bold">
              ...
              <sup style={{ color: isHome ? "#FFFFFF" : "#000000" }}>{cart.length}</sup>
            </span>
            ...
            <span className="d-flex ms-3 fw-bold">
              ...
              <sup style={{ color: isHome ? "#FFFFFF" : "#000000" }}>{wishlist.length}</sup>
            </span>
          </Nav>
        </Navbar.Collapse>
      </Container>
